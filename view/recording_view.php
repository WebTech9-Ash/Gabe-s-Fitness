        ...
        <div class="hero">
            ...
            <form action="" method="POST" class="daily_records">
                ...
                <div class="recordbox">
                    ...
                    <input type="number" id="sleepHours" name="sleepHours" placeholder="Enter hours of sleep " min="0" step="0.5" required>
                </div>

                <!-- calorie goal -->
                <div class="recordbox">
                    <div>
                        <label for="calories"> How many calories were in your meal today? </label>
                        <div class="icons">
                            <ion-icon name="restaurant-outline" style="width: 35px; height: 25px; color: var(--primary-color);"></ion-icon>
                        </div>
                    </div>
                    <input type="number" id="calories" name="calories" placeholder="Enter caloric intake" min="0" required>
                </div>

                <!--  workout goal -->
                <div class="recordbox">
                    <div>
                        <label for="workoutsPerMonth"> How many workouts have you had today?</label>
                        <div class="icons">
                            <ion-icon name="walk-outline" style="width: 35px; height:25px; color: var(--primary-color);"></ion-icon>
                        </div>
                    </div>
                    <input type="number" id="workoutsPerMonth" name="workoutsPerMonth" placeholder="Enter number of workouts" min="0" required>
                </div>

                <!--  weight loss goal -->
                <div class="recordbox">
                    <div>
                        <label for="weightloss"> What is your weight today? </label>
                        <div class="icons">
                            <ion-icon name="flame-outline" style="width: 35px; height:25px; color: var(--primary-color);"></ion-icon>
                        </div>
                    </div>
                    <input type="number" id="weightloss" name="weightloss" placeholder="Enter weight" min="0" required>
                </div>

                <button type="submit" class="btn" onclick="goBack()"> Record </button>
